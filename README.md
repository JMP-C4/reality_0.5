...
│
├── src/
│   ├── components/         # Interfaz o panel de control
│   ├── controllers/        # Lógica de acciones (mouse, sistema, etc.)
│   ├── services/           # MediaPipe y mapeo de gestos
│   ├── utils/              # Funciones auxiliares
│   └── main.py             # Punto de entrada
│
├── tests/                  # Pruebas unitarias
├── assets/                 # Modelos o recursos adicionales
│
├── requirements.txt
├── .gitignore
└── README.md
